						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a <?php echo "href='edit.php?id=" . $row['id'] . "&action=editcategory'" ?> title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
										 <a <?php echo "href='delete.php?id=" . $row['id'] . "&action=deletecategory'" ?> title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a> 
